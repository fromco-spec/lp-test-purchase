/**
 * to esella ミラーフォース FV1（nine/lp/mirrorforce/base1_soku / 即チャ版）
 *
 * 通常版 (toesella-mirrorforce.mjs) との差分:
 *   - URLが base1_soku.html
 *   - LP着地時点でBOTが自動起動するため、CTAクリックフェーズを削除
 *
 * その他の構造は通常版と同じ前提。
 */

const TARGET_URL = 'https://www.toesella.com/nine/lp/mirrorforce/base1_soku.html';
